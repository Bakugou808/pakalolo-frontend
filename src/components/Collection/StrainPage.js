...
import { postTag, fetchAllTags } from "../../Redux/actions/tagActions";
...
function StrainPage(props) {
  ...
  useEffect(() => {
    strain.likes.length > 0
      ? strain.likes.forEach((like) =>
          like.user_id == localStorage.userId ? setLiked(true) : setLiked(false)
        )
      : setLiked(false);
            ...
            (edit ? (
              ...
              <>
                ...
                <Modal.Body>
                  <div className="form-group">
                    <Button
                      onClick={() => setCreateTag((prev) => !prev)}
                      style={newTagStyle}
                    >
                      {createTag ? "Cancel" : "New Tag"}
                    </Button>
                    {createTag ? (
                      <form className="" onSubmit={handleTag}>
                        <div className="form-group">
                      ...
                      <Autocomplete
                        ...
                        renderInput={(params) => (
                          <TextField
                            {...params}
                            label={title ? title : "Select from Tags"}
                            margin="normal"
                            required
                          />
                        )}
